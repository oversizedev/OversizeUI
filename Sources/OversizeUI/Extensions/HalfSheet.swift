...
public extension View {
    ...
    @ViewBuilder func sheet<T: View>(isPresented: Binding<Bool>,
                                     detents _: [SheetSize] = [.medium, .large],
                                     smallestUndimmedDetentIdentifier _: SheetSize = .medium,
                                     prefersScrollingExpandsWhenScrolledToEdge _: Bool = false,
                                     prefersEdgeAttachedInCompactHeight _: Bool = true,
