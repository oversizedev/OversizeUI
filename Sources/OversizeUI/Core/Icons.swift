...
public extension SwiftUI.Image {
    enum Base {
        ...
        public static let attach = Image("Base/Attach", bundle: .module)
        public enum Bag {
        ...
        public static let clear = Image("Base/Clear", bundle: .module)
        public enum Clock {
        ...
        public static let link = Image("Base/Link", bundle: .module)
        ...
        public static let nearMe = Image("Base/NearMe", bundle: .module)
        ...
        public enum Plus {
            public static let mini = Image("Base/Plus/Mini", bundle: .module)
            public enum Square {
                public static let fill = Image("Base/Plus/Square/Fill", bundle: .module)
                public enum TwoTone {
                    public static let fill = Image("Base/Plus/Square/TwoTone/Fill", bundle: .module)
                }

                public static let twoTone = Image("Base/Plus/Square/TwoTone", bundle: .module)
            }

            public static let square = Image("Base/Plus/Square", bundle: .module)
        }
